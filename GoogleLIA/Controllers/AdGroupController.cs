...
namespace GoogleLIA.Controllers
{
    public class AdGroupController : Controller
    {
        ...
        public List<(long, string)> GetCampaignList()
        {
            ...
            GoogleAdsServiceClient googleAdsService = googleAdsClient.GetService(Services.V14.GoogleAdsService);
        ...
        public void createAdGroup()
        {
            ...
            AdGroupServiceClient adGroupService = googleAdsClient.GetService(Services.V14.AdGroupService);
